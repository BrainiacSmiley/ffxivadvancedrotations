...
function getTankJobIds(
  lvl = [FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL]
) {
  let tankJobIds = [];
...
function getMeleeJobIds(
  lvl = [FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL]
) {
  let meleeJobIds = [];
...
function getMagicalRangeJobIds(
  lvl = [FFXIVMAXLVL, FFXIVMAXLVL, FFXIVMAXLVL /* , FFXIVMAXLVL-20 */]
) {
...
function getDoWDoMJobIds(
  ...
  dowDomJobIds = [].concat(
    dowDomJobIds,
    getPhysicalRangeJobIds(lvl.slice(13, 16))
  );
  dowDomJobIds = [].concat(
    dowDomJobIds,
    getMagicalRangeJobIds(lvl.slice(16, 19))
  );
